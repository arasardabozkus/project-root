<form action="<?=base_url('admin/update_langs')?>" method="post" id = "form">
    <img src="<?=base_url('assets/dist/img/info/home.png')?>" alt="" style="width: 75%;height: 75%">
    <p></p>
    ...
    <div class="container" id = "formelements">
        <div class="row">
            <div class="col-lg-4">
                ...
                <br>
                <input class="form-control" id="profession" name="Profession" required="required" type="text" value="<?=$content['Home']['Profession']?>">
                <br>
                <p></p>
            </div>
            <div class="col-lg-1">
            ...
            <div class="col-lg-4">
                <label for="aboutmebutton">Hakkımda Butonu</label>
                <br>
                <input class="form-control" id="aboutmebutton" name="AboutMeButton" required="required" type="text" value="<?=$content['Home']['AboutMeButton']?>">
                <br>
                <p></p>
            </div>
            <div class="col-lg-3">
