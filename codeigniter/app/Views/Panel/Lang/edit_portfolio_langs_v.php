<form action="<?=base_url('admin/update_langs')?>" method="post" id = "form">
    <img src="<?=base_url('assets/dist/img/info/portfolio_langs.png')?>" alt="" style="max-width: 100%">
    <p></p>
    ...
    <div class="container" id = "formelements">
        <div class="row">
            <div class="col-lg-4">
                <label for="works">İşlerim</label>
                <br>
                <input class="form-control" id="works" name="Works" required="required" type="text" value="<?=$content['Portfolio']['Works']?>">
                <br>
                <p></p>
            </div>
            ...
            <div class="col-lg-4">
                ...
                <br>
                <input class="form-control" id="portfolio" name="Portfolio" required="required" type="text" value="<?=$content['Portfolio']['Portfolio']?>">
                <br>
                <p></p>
            </div>
