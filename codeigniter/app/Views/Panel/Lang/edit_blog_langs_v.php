<form action="<?=base_url('admin/update_langs')?>" method="post" id = "form">
    <img src="<?=base_url('assets/dist/img/info/blog_langs.png')?>" alt="" style="max-width: 100%">
    <p></p>
    ...
    <div class="container" id = "formelements">
        <div class="row">
            <div class="col-lg-4">
                <label for="news">Güncel Haberler (News)</label>
                <br>
                <input class="form-control" id="news" name="News" required="required" type="text" value="<?=$content['Blog']['News']?>">
                <br>
                <p></p>
            </div>
            ...
            <div class="col-lg-4">
                ...
                <br>
                <input class="form-control" id="title" name="Title" required="required" type="text" value="<?=$content['Blog']['Title']?>">
                <br>
                <p></p>
            </div>
