<form action="<?=base_url('admin/update_langs')?>" method="post" id = "form">
    <img src="<?=base_url('assets/dist/img/info/expertise_langs.png')?>" alt="" style="max-width: 100%">
    <p></p>
    ...
    <div class="container" id = "formelements">
        <div class="row">
            <div class="col-lg-4">
                <label for="set">Neler Yapabilirim? (What I Do?)</label>
                <br>
                <input class="form-control" id="set" name="Set" required="required" type="text" value="<?=$content['Expertise']['Set']?>">
                <br>
                <p></p>
            </div>
            ...
            <div class="col-lg-4">
                <label for="expertise">Uzmanlık(Expertise)</label>
                <br>
                <input class="form-control" id="expertise" name="Expertise" required="required" type="text" value="<?=$content['Expertise']['Expertise']?>">
                <br>
                <p></p>
            </div>
