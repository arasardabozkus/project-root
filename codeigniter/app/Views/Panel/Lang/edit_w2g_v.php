<form action="<?=base_url('admin/update_langs')?>" method="post" id = "form">
    <img src="<?=base_url('assets/dist/img/info/w2g_langs.png')?>" alt="" style="max-width: 100%">
    <p></p>
    ...
    <div class="container" id = "formelements">
        <div class="row">
            <div class="col-lg-4">
                <label for="w2g">Benimle Çalışabişirsiniz</label>
                <br>
                <input class ="form-control" id="w2g" name="W2G" required="required" type="text" value="<?=$content['Work2Gether']['W2G']?>">
                <br>
                <p></p>
            </div>
            ...
            <div class="col-lg-4">
                <label for="hireme">İletişime Geçin</label>
                <br>
                <input class ="form-control" id="hireme" name="HireMe" required="required" type="text" value="<?=$content['Work2Gether']['HireMe']?>">
                <br>
                <p></p>
            </div>
