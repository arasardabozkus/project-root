                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?=base_url('admin/langs/content/tr/edit_langs_v')?>" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Diller</p>
                                </a>
                            </li>
                            ...
                            <div class="card-body" style="display: flex;flex-direction: column">
                                ...
                                <div class="form-group" style="width:400px; max-width: 100%">
                                    <select class="form-control" name="pages" id ="pages">
                                        <option value="edit_nav_v">Nav</option>
                                        <option value="edit_home_v">Ana sayfa</option>
                                        <option value="edit_about_lang_v">Hakkımda</option>
                                        <option value="edit_expertise_lang_v">Uzmanlık</option>
                                        <option value="edit_services_lang_v">Hizmetlerim</option>
                                        <option value="edit_w2g_v">Birlikte Çalışalım</option>
                                        <option value="edit_portfolio_langs_v">Portfolyo</option>
                                        <option value="edit_portfolio_page_v">Portfolyo Sayfası</option>
                                        <option value="edit_testimonial_langs_v">Referanslar</option>
                                        <option value="edit_blog_langs_v">Blog</option>
                                        <option value="edit_contact_langs_v">İletişim</option>
                                    </select>
                                </div>
                                <p></p>
                                <p id = "afterp"></p>
