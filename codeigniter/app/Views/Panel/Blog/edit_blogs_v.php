                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?=base_url('admin/edit_blogs/tr')?>" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Blogları Yönet</p>
                                </a>
                            </li>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Blogları Yönet</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
    ...
    <script>
        $(function (){
            ...
            $('#langs').change(function (){
                ...
                $.ajax({
                    type:"GET",
                    url:"<?=base_url('admin/edit_blogs/')?>"+lang,
            ...
            $('#editButton').click(function (){
                for (let i =0;i<<?=count($contents)?>;i++){
                    if($('#c'+i).is(':checked')){
                        ...
                        $.ajax({
                            type:"GET",
                            url:"<?=base_url('admin/alter_blog/')?>" + id,
                            async: false,
                            success: function (data){
                                $('#pageContent').remove();
                                $('#afterp').after(data);
            ...
            $('#rmButton').click(function (){
                for (let i =0;i<<?=count($contents)?>;i++){
                    if($('#c'+i).is(':checked')){
                        let title = $('#t'+i).text();
                        let id = $('#p'+i).text();
                        if(confirm(title + ' Başlıklı blog silinecek, onaylıyor musunuz?')){
                            $.ajax({
                                type: "GET",
